...
export async function checkUpdate(): Promise<AppVersion | undefined> {
  ...
  let url = 'https://github.com/Cranberrycrisp/sparkle/releases/latest/download/latest.yml'
  if (updateChannel == 'beta') {
    url = 'https://github.com/Cranberrycrisp/sparkle/releases/download/pre-release/latest.yml'
  }
...
export async function downloadAndInstallUpdate(version: string): Promise<void> {
  ...
  const baseUrl = `https://github.com/Cranberrycrisp/sparkle/releases/download/${releaseTag}/`
  const fileMap = {
  ...
  const apiUrl = `https://api.github.com/repos/Cranberrycrisp/sparkle/releases/tags/${releaseTag}`
