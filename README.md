...
<p align="center">
  <a href="https://github.com/Cranberrycrisp/sparkle/releases">
    <img src="https://img.shields.io/github/release/Cranberrycrisp/sparkle/all.svg">
  </a>
...
```bash
git clone https://github.com/Cranberrycrisp/sparkle.git
cd sparkle
```
...
<a href="https://www.star-history.com/#Cranberrycrisp/sparkle&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=Cranberrycrisp/sparkle&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=Cranberrycrisp/sparkle&type=Date" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=Cranberrycrisp/sparkle&type=Date" />
 </picture>
</a>
